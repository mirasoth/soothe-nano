...
tags: github, git hub, pull request, pr, issue, ci, repository, gh cli
when_to_use: >
  Use when working with GitHub repositories, pull requests, issues, releases,
  or CI/CD workflows, and the `gh` CLI is available.
