...
tags: drawio, draw.io, diagram, flowchart, architecture, uml, sequence, class, bpmn, swimlane, mind map, network topology, sysml
paths:
  - "*.drawio"
  - "*.drawio.xml"
  - "*.dio"
when_to_use: >
  Use for diagrams, flowcharts, architecture / ER / UML / SysML / BPMN
  diagrams, swimlanes, network topology, mind maps, or any visualization that
  needs custom styling and exportable images (PNG/SVG/PDF/JPG).
license: MIT
