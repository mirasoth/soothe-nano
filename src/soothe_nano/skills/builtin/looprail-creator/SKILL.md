...
paths:
  ...
  - "soothe/rails/**"
when_to_use: >
  Use when creating, drafting, distilling, editing, reviewing, or promoting a
  Soothe LoopRail (autopilot workflow pattern), or validating that a rail
  matches the LoopRail protocol.
---
