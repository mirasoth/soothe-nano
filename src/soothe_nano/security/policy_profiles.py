...
"""Plan profile: same read-only constraints as Ask, but no subagent spawning
(plan mode produces a plan; implementation is deferred to Agent mode)."""
